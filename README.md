...
graph LR
    ...
    MCU -->|PE7| R1["R 220-330Ω"] --> LED1(("LED 1"))
    MCU -->|PE8| R2["R 220-330Ω"] --> LED2(("LED 2"))
    MCU -->|PE9| R3["R 220-330Ω"] --> LED3(("LED 3"))
    MCU -->|PE10| R4b["R 220-330Ω"] --> LED4(("LED 4"))
    MCU -->|PE11| R5["R 220-330Ω"] --> LED5(("LED 5 - OBJETIVO"))
    MCU -->|PE12| R6["R 220-330Ω"] --> LED6(("LED 6"))
    MCU -->|PE13| R7["R 220-330Ω"] --> LED7(("LED 7"))
    MCU -->|PE14| R8b["R 220-330Ω"] --> LED8(("LED 8"))
